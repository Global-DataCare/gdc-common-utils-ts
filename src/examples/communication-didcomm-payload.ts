...
export const EXAMPLE_DIDCOMM_COMMUNICATION_ENTRY_TYPE = 'Communication-attached-bundle-v1.0' as const;
...
export const EXAMPLE_DIDCOMM_ACK_TYPE = 'Communication-ack-v1.0' as const;
export const EXAMPLE_DIDCOMM_ACK_BODY_OK_KEY = 'ok' as const;
export const EXAMPLE_DIDCOMM_ACK_BODY_RECEIVED_MEDICATION_IDENTIFIER_KEY =
  'receivedMedicationIdentifier' as const;
export const EXAMPLE_DIDCOMM_ACK_BODY_RECEIVED_DOCUMENT_IDENTIFIER_KEY =
  'receivedDocumentIdentifier' as const;
...
export const EXAMPLE_APPOINTMENT_PARTICIPANT_STATUS = 'accepted' as const;
