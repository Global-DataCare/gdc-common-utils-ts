...
export const EXAMPLE_CONSENT_ACCESS_COUNTRY_ACTOR_IDENTIFIER =
  `urn:iso:3166:${EXAMPLE_CONSENT_ACCESS_JURISDICTION}`;
export const EXAMPLE_CONSENT_ACCESS_SUBDIVISION = 'CA-BC';
export const EXAMPLE_CONSENT_ACCESS_SUBDIVISION_ACTOR_IDENTIFIER =
  `urn:iso:3166-2:${EXAMPLE_CONSENT_ACCESS_SUBDIVISION}`;
