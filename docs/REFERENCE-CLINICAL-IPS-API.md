...
| `MedicationStatement.adherence` | `setAdherence(...)` | `getAdherence()` | `HealthcareBasicSections.HistoryOfMedicationUse.attributeValue` | `adherence` (R5 token) | no | yes | maps to R5 `adherence.code`; unavailable as a native R4 element |
